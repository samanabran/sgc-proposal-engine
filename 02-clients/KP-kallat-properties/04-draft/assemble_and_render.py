...
DRAFT_DIR = Path(
    r"C:\sgc_proposal_engine\02-clients\KP-kallat-properties\03-draft"
    r"\KP-2026-SUB-01_Rev1"
)
OUT_HTML = Path(
    r"C:\sgc_proposal_engine\02-clients\KP-kallat-properties\04-draft"
    r"\KP-2026-SUB-01_Rev1_Internal.html"
)
...
<p>Revision 1 &middot; Subscription Recovery Model &middot; Kallat Properties</p>
